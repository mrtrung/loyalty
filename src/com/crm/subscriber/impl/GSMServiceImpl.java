...
{
	public static void report(Connection connection, long userId, String userName, String isdn, Date reportTime, long mcc, long mnc, String type, long lac, long cellId, long rnc, long psc, String signal, String latitude, String longitude, int voiceStatus, int smsStatus, int speedStatus, String description, int status) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static void report(long userId, String userName, String isdn, Date reportTime, long mcc, long mnc, String type, long lac, long cellId, long rnc, long psc, String signal, String latitude, String longitude, int voiceStatus, int smsStatus, int speedStatus, String description, int status) throws Exception
	{
		...
		try
		{
			...
			report(connection, userId, userName, isdn, reportTime, mcc, mnc, type, lac, cellId, rnc, psc, signal, latitude, longitude, voiceStatus, smsStatus, speedStatus, description, status);
		} catch (Exception e)
		{
			throw e;
		} finally
	...
	public static MerchantAgent getAgent(String isdn) throws Exception
	{
		Connection connection = null;
