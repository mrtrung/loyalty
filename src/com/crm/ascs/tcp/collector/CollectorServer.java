...
public class CollectorServer extends NetThread
{
	...
	private void openSocket() throws IOException
	{
		...
		server.setReceiveBufferSize(dispatcher.socketBufferLength);
		InetSocketAddress address = new InetSocketAddress(dispatcher.listenPort);
	...
	public void process() throws Exception
	{
		try
		{
			...
			else
			{
				...
				socket.setReceiveBufferSize(dispatcher.socketBufferLength);
