...
public class QueueFactory_old
{
	...
	public static MessageProducer createQueueProducer(QueueSession session, Queue queue, long timeout, boolean isPersistent)
			throws JMSException
	{
	...
	public static QueueSession createQueueSession(QueueConnection connection) throws Exception
	{
	...
	public static int getCommandLogQueueSize()
	{
		return commandLogQueue.size();
	}

	public static void attachCommandLog(CommandMessage request)
	{
		commandLogQueue.offer(request);
	}

	public static CommandMessage detachCommandLog()
	{
		return commandLogQueue.poll();
	}

	public static int getStatisticQueueSize()
	{
		return commandStatiticQueue.size();
	}
	...
	public static void sendMessage(QueueSession queueSession, Queue queue, Message message, long timeout, boolean isPersistent)
			throws Exception
	{
	...
	public static void sendMessage(QueueSession queueSession, Queue queue, Message message, boolean isPersistent)
			throws Exception
	{
	...
	public static Message createObjectMessage(QueueSession queueSession, Serializable content) throws Exception
	{
		try
		{
			...
			{
				message.setJMSCorrelationID(((CommandMessage) content).getCorrelationID());
			}

			if (content instanceof OSACallbackMessage)
			{
				message.setJMSCorrelationID(((OSACallbackMessage) content).getSessionId());
			}
	...
	public static Queue createQueue(Object queueSession, String queueName) {
